...
<div class="container">
  ...
  <div class="top-right">
    <!-- First row buttons -->
<div class="first-row">
  <button onclick="scrollToFooter()" disabled><i class="fas fa-envelope"></i> Contact Us</button>
  <a href="support.html">
    <button disabled><i class="fas fa-life-ring"></i> Support</button>
  </a>
  <a href="login.html">
    ...
    <div class="second-row">
      <div class="dropdown">
        <button class="dropbtn" disabled><i class="fas fa-book"></i> Book & Manage</button>
      ...
      <div class="dropdown">
        <button class="dropbtn" disabled><i class="fas fa-globe"></i> Where We Fly</button>
        <div class="dropdown-content">
      ...
      <div class="dropdown">
        <button class="dropbtn" disabled><i class="fas fa-suitcase"></i> Prepare to Travel</button>
        <div class="dropdown-content">
      ...
      <button disabled><i class="fas fa-hands-helping"></i> MNZ Experience</button></a>
    </div>
  </div>
